...
traps %>%
  ...
  theme_bw() +
  theme(legend.position = c(0.8, 0.5), legend.title = element_text(size = 10), axis.text = element_text(size = 10), axis.title = element_text(size = 12), legend.text = element_text(size = 10)) +
...
ggsave("../outputs/figures/Fig 3.tiff", dpi = 300, width = 19, height = 15, units = "cm", compression = "lzw")
```
